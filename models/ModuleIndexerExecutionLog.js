...
var _modelName = 'ModuleIndexerExecutionLog';

var _createModelSchema = function(mongoose) {
   //banner schema definition
   var moduleIndexerExecutionLogSchema = new mongoose.Schema({
     modulePath: {
        type: String,
        required: true,
        unique: false
     ...
     indexerExecutionLog: {
         ...
         ref: 'IndexerExecutionLog',
         required: true,
         unique: false
     }
   });

   return moduleIndexerExecutionLogSchema;
}
